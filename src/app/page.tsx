  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Before: Original Screenshot</h3>
                <img 
                  ...
                  className="w-full rounded-lg border-2 border-zinc-200 dark:border-zinc-800 shadow-lg" 
                />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-4">After: Protected with SafeSnap</h3>
                <img 
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 p-3 rounded-full bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 hover:border-indigo-600 dark:hover:border-purple-600 transition-colors shadow-lg"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 p-3 rounded-full bg-white dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 hover:border-indigo-600 dark:hover:border-purple-600 transition-colors shadow-lg"
            ...
            {scenarios.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === currentSlide
                    ? 'w-8 bg-indigo-600 dark:bg-purple-600'
      ...
      <section id="about" className="container mx-auto px-6 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">About SafeSnap</h2>
        <div className="max-w-3xl mx-auto bg-zinc-50 dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-8 space-y-6">
          <div>
